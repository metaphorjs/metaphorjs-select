define("metaphorjs-select",function(){function H(k){if(k&&void 0!=!k.length&&k!==""+k){for(var n=[],r=-1,I=k.length>>>0;++r!==I;n[r]=k[r]);return n}return k?[k]:[]}var A=A||{};var l=A.getAttr=function(k,n){return k.getAttribute?k.getAttribute(n):null},O=function(){var k=[],n=function(r){var n;var B=0;for(n=k.length;B<n;B++)k[B][0].call(k[B][1],r);"undefined"!=typeof console&&console.error&&console.error(r)};n.on=function(r,l){n.un(r,l);k.push([r,l])};n.un=function(n,l){var r;var z=0;for(r=k.length;z<
r;z++)if(k[z][0]===n&&k[z][1]===l){k.splice(z,1);break}};return n}();A.select=function(){var k=/^[\w[:#.][\w\]*^|=!]*$/,n=/=([^\]]+)/,r=/ *, */,A=/(\([^)]*)\+/,B=/(\[[^\]]+)~/,z=/(~|>|\+)/,P=/ +/,Q=/([^[:.#]+)?(?:#([^[:.#]+))?(?:\.([^[:.]+))?(?:\[([^!&^*|$[:=]+)([!$^*|&]?=)?([^:\]]+)?\])?(?::([^(]+)(?:\(([^)]+)\))?)?/,R=/(?:(-?\d*)n)?(?:(%|-)(\d*))?/,S=/\D/,T=/[^(]*\(([^)]*)\)/,U=/\(.*/,V=/\[([^!~^*|$ [:=]+)([$^*|]?=)?([^ :\]]+)?\]/,C=window.document,W=!!C.getElementsByClassName,K=!!C.querySelectorAll,
