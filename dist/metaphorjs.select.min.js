(function(){function H(k){if(k&&void 0!=!k.length&&k!==""+k){for(var n=[],r=-1,I=k.length>>>0;++r!==I;n[r]=k[r]);return n}return k?[k]:[]}var z={plugin:{},mixin:{},lib:{}};z.dom=z.dom||{};var l=z.dom.getAttr=function(k,n){return k.getAttribute?k.getAttribute(n):null},O=function(){var k=[],n=function(r){var n;var B=0;for(n=k.length;B<n;B++)k[B][0].call(k[B][1],r);"undefined"!=typeof console&&console.error&&console.error(r)};n.on=function(r,l){n.un(r,l);k.push([r,l])};n.un=function(n,l){var r;var A=
0;for(r=k.length;A<r;A++)if(k[A][0]===n&&k[A][1]===l){k.splice(A,1);break}};return n}();z.dom.select=function(){var k=/^[\w[:#.][\w\]*^|=!]*$/,n=/=([^\]]+)/,r=/ *, */,z=/(\([^)]*)\+/,B=/(\[[^\]]+)~/,A=/(~|>|\+)/,P=/ +/,Q=/([^[:.#]+)?(?:#([^[:.#]+))?(?:\.([^[:.]+))?(?:\[([^!&^*|$[:=]+)([!$^*|&]?=)?([^:\]]+)?\])?(?::([^(]+)(?:\(([^)]+)\))?)?/,R=/(?:(-?\d*)n)?(?:(%|-)(\d*))?/,S=/\D/,T=/[^(]*\(([^)]*)\)/,U=/\(.*/,V=/\[([^!~^*|$ [:=]+)([$^*|]?=)?([^ :\]]+)?\]/,C=window.document,W=!!C.getElementsByClassName,
