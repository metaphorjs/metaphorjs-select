(function(){function H(k){if(k&&void 0!=!k.length&&k!==""+k){for(var n=[],r=-1,I=k.length>>>0;++r!==I;n[r]=k[r]);return n}return k?[k]:[]}var z={plugin:{},mixin:{},lib:{}};z.dom=z.dom||{};var l=function(k,n){return k.getAttribute?k.getAttribute(n):null},O=function(){var k=[],n=function(r){var n;var B=0;for(n=k.length;B<n;B++)k[B][0].call(k[B][1],r);"undefined"!=typeof console&&console.error&&console.error(r)};n.on=function(r,l){n.un(r,l);k.push([r,l])};n.un=function(n,l){var r;var A=0;for(r=k.length;A<
r;A++)if(k[A][0]===n&&k[A][1]===l){k.splice(A,1);break}};return n}();z.dom.select=function(){var k=/^[\w[:#.][\w\]*^|=!]*$/,n=/=([^\]]+)/,r=/ *, */,z=/(\([^)]*)\+/,B=/(\[[^\]]+)~/,A=/(~|>|\+)/,P=/ +/,Q=/([^[:.#]+)?(?:#([^[:.#]+))?(?:\.([^[:.]+))?(?:\[([^!&^*|$[:=]+)([!$^*|&]?=)?([^:\]]+)?\])?(?::([^(]+)(?:\(([^)]+)\))?)?/,R=/(?:(-?\d*)n)?(?:(%|-)(\d*))?/,S=/\D/,T=/[^(]*\(([^)]*)\)/,U=/\(.*/,V=/\[([^!~^*|$ [:=]+)([$^*|]?=)?([^ :\]]+)?\]/,C=window.document,W=!!C.getElementsByClassName,K=!!C.querySelectorAll,
u={"first-child":function(a){return a.parentNode.getElementsByTagName("*")[0]!==a},"last-child":function(a){for(;(a=a.nextSibling)&&1!==a.nodeType;);return!!a},root:function(a){return"html"!==a.nodeName.toLowerCase()},"nth-child":function(a,b){var c=a.nodeIndex||0,d=b[3]=b[3]?("%"===b[2]?-1:1)*b[3]:0;b=b[1];if(c)return!((c+d)%b);var h=a.parentNode.firstChild;c++;do if(1===h.nodeType&&(h.nodeIndex=++c)&&a===h&&(c+d)%b)return 0;while(h=h.nextSibling);return 1},"nth-last-child":function(a,b){var c=a.nodeIndexLast||
0,d=b[3]?("%"===b[2]?-1:1)*b[3]:0;b=b[1];if(c)return!((c+d)%b);var h=a.parentNode.lastChild;c++;do if(1===h.nodeType&&(h.nodeLastIndex=c++)&&a===h&&(c+d)%b)return 0;while(h=h.previousSibling);return 1},empty:function(a){return!!a.firstChild},parent:function(a){return!a.firstChild},"only-child":function(a){return 1!==a.parentNode.getElementsByTagName("*").length},checked:function(a){return!a.checked},lang:function(a,b){return a.lang!==b&&C.documentElement.lang!==b},enabled:function(a){return a.disabled||
...
c:[])}else{for(var D=a.split(r),E=D.length-1,I=!!E,L,M,g,J,v,w,x,y,N,e,F,G;d=D[E--];){M=(L=d.replace(z,"$1%").replace(B,"$1&").replace(A," $1 ").split(P)).length;h=0;J=" ";for(t=b instanceof DocumentFragment?b.children:[b];g=L[h++];)if(" "!==g&&">"!==g&&"~"!==g&&"+"!==g&&t){g=g.match(Q);v=g[1]||"*";w=g[2];x=g[3]?" "+g[3]+" ":"";a=g[4];p=g[5]||"";m=g[7];l="nth-child"===m||"nth-last-child"===m?R.exec("even"===g[8]&&"2n"||"odd"===g[8]&&"2n%1"||!S.test(g[8])&&"0n%"+g[8]||g[8]):g[8];y=[];d=N=0;for(F=h===
...
-1==(" "+f.className+" ").indexOf(x)||!(!a||q[p]&&(q[p](f,a,g[6])||"class"===a&&q[p](f,"className",g[6])))||f.yeasss||(u[m]?u[m](f,l):m)||(F&&(f.yeasss=1),y[d++]=f)}t=y}else J=g;if(I){if(!t.concat){y=[];for(e=0;f=t[e];)y[e++]=f;t=y}c=t.concat(1===c.length?c[0]:c)}else c=t}for(d=c.length;d--;)c[d].yeasss=c[d].nodeIndex=c[d].nodeIndexLast=null}return c}}();"undefined"!=typeof global?global.MetaphorJs=z:window.MetaphorJs=z})();
